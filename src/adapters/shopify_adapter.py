...
class ShopifyAdapter:
    def __init__(self, store_name: str, base_url: str):
        ...
        # Определяем валюту магазина ОДИН РАЗ
        self.store_currency = detect_currency(self.base_url)
    
    def fetch_products(self, limit: int = 250) -> list:
        all_products, page = [], 1
        while True:
    ...
    def import_products(self, db: Session, products: list):
        ...
        imported = updated = skipped = currency_converted = 0
        ...
        for product_data in products:
            try:
                ...
                for variant_data in product_data.get('variants', []):
                    ...
                    # Конвертируем в USD
                    price, original_currency = normalize_price(price, product_url, api_currency)
                    ...
                    if existing_offer and existing_offer.current_price:
                        if not self.is_plausible_change(existing_offer.current_price, price):
                            skipped += 1
                            continue
                    ...
                    if existing_offer:
                        ...
                        db.add(Offer(
                            ...
                            url=product_url,
                            current_price=price, old_price=old_price,
        ...
        db.commit()
        print(f"✅ Imported: {imported}, Updated: {updated}, Skipped: {skipped}, Currency converted: {currency_converted}")
